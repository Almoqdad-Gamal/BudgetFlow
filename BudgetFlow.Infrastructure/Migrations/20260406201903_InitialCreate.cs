        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetPeriods_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BudgetPeriods_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Expenses_Users_ReviewedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetPeriods_DepartmentId_Month_Year",
                table: "BudgetPeriods",
                columns: new[] { "DepartmentId", "Month", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BudgetPeriods_TenantId",
                table: "BudgetPeriods",
                column: "TenantId");
